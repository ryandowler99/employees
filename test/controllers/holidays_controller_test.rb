...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference("Holiday.count") do
      post holidays_url, params: { holiday: { employee_id: @holiday.employee_id, enddate: @holiday.enddate, startdate: @holiday.startdate } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { employee_id: @holiday.employee_id, enddate: @holiday.enddate, startdate: @holiday.startdate } }
